 ...
 * @author KOMPUTER
 */
public class SprayAndWaitDecisionEngine2 implements RoutingDecisionEngine {
    ...
    public SprayAndWaitDecisionEngine2(Settings s) {

        initialNrofCopies = s.getInt(NROF_COPIES);
        isBinary = s.getBoolean(BINARY_MODE);
    }

    public SprayAndWaitDecisionEngine2(SprayAndWaitDecisionEngine2 snw) {
    ...
    public RoutingDecisionEngine replicate() {
        return new SprayAndWaitDecisionEngine2(this);
    }
